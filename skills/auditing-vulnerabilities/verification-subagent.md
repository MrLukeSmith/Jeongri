...
| Verdict | Action |
|---|---|
| **Confirmed** | `status: confirmed`; severity locked as assigned; `exploitability` set from the proven attack path; use the verifier's evidence verbatim in the report's per-finding detail |
